 ...
 */
fun setCustomValue(meta: ItemMeta, plugin: Tournament, id: String, value: Any) {
 ...
 */
fun checkCustomValue(meta: ItemMeta, plugin: Tournament, id: String, value: Any): Boolean {
    val key = NamespacedKey(plugin, id)
    return when (value) {
        is String -> {
 ...
 */
fun getCustomValue(meta: ItemMeta, plugin: Tournament, id: String): Any? {
    val key = NamespacedKey(plugin, id)
    return when {
